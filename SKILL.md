...
description: >-
  ...
  text/image embeddings, document reranking, PDF extraction, and vision-language
  chat. No SDK or MCP required — just curl with a Bearer token. Covers: Reader
  API (URL to markdown, screenshots), Search API (web, arXiv, SSRN, images,
  query expansion), Embeddings API, Reranker API, PDF figure/table extraction,
  and VLM API (image + text chat).
---
