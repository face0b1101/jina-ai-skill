...
- `SKILL.md` and `README.md`: document co-located skill-root `.env` sourcing via
  `SKILL_ROOT` (directory containing `SKILL.md`) instead of a hardcoded
  `~/.agents/skills/...` path; note `.claude/skills/` and other install locations

## [1.3.2] - 2026-06-02

### Changed

- `SKILL.md` and `README.md`: document gitignored skill-root `.env` and `set -a &&
  source` pre-flight before Jina API calls
...
[unreleased]: https://github.com/face0b1101/jina-ai-skill/compare/v1.3.3...HEAD
[1.3.3]: https://github.com/face0b1101/jina-ai-skill/compare/v1.3.2...v1.3.3
[1.3.2]: https://github.com/face0b1101/jina-ai-skill/compare/v1.3.1...v1.3.2
